...
syn region gitUnmerged matchgroup=gitSectionHeader start='^# Unmerged paths:' end='^$' contains=gitMrgFile fold
...
syn region gitMrgFile  start='^\t\[?\]' end='$' contained
